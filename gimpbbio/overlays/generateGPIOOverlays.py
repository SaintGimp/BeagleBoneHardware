# Based on code from https://github.com/nomel/beaglebone

# Generates device tree overlays for runtime config of every gpio pin.
# 	creates dts files, compile script, and install script
#
# Usage:
#   python3 generateGPIOOverlays.py	# generates the dts files in the dts directory.
#	cd generated
#   sh compile.sh
#   sh install.sh
# 
# Set P9.11 to gpio, input enabled, pull up
...
if __name__ == "__main__":
	...
	for combo in combinations:
		...
		muxMode = functools.reduce(operator.or_, values, 0)	# or all of the values together
